        ...
        <section class="card p-4 my-5 rounded-4 shadow-lg border-0" style="max-width: 1000px; width: 100%;">
            ...
            <form class="needs-validation" action="VentasController" method="POST" novalidate>
                ...
                <div class="row g-4 mb-3">
                	<div class="col-6">
                        <input type="text" name="txtDNI" class="form-control form-control-lg" 
                ...
                <div class="row g-4 mb-3">
                	<div class="col-6">
                        <input type="text" name="txtApellidos" class="form-control form-control-lg" 
                ...
                <div class="row g-4 mb-3">
                	<div class="col-6">
                        <input type="text" name="txtPrecio" class="form-control form-control-lg" 
                               placeholder="Precio" required>
                        <div class="invalid-feedback">Falta Precio.</div>
                    </div>
                    
                    <div class="col-6">
                        <input type="text" name="txtTotal" class="form-control form-control-lg" 
			...
			<div class="input-group mb-3 shadow-sm">
                ...
                <input type="text" class="form-control form-control-lg" placeholder="Buscar Venta">
            </div>
