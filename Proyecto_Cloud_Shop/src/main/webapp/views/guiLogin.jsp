...
<body style="background-color: #f5f6f8;">
    ...
    <main class="d-flex justify-content-center align-items-center" style="height: 100vh;">
        <section class="card p-4 rounded-4 shadow-lg border-0" style="max-width: 430px; width: 100%;">

            <form class="needs-validation" novalidate action="guiUsuarios.jsp">
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-lg w-100 text-white"style="background-color: #042b54;">INGRESAR</button>
                </div>

                <div class="text-center mt-3">
                    <a href="#" class="text-decoration-none" style="color: #042b54;">¿Olvidaste tu contraseña?</a>
                </div>
            </form>
